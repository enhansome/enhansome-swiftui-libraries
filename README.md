# Awesome SwiftUI Libraries :rocket: :rocket: :rocket: with stars
...
* [SPAlert](https://github.com/ivanvorobei/SPAlert) ⭐ 2,631 | 🐛 7 | 🌐 Swift | 📅 2024-08-11 - Native alert from Apple Music & Feedback. Contains Done, Heart & Message and other presets. Support SwiftUI.
* [AlertToast](https://github.com/elai950/AlertToast) ⭐ 2,445 | 🐛 31 | 🌐 Swift | 📅 2024-11-12 - Create Apple-like alerts & toasts using SwiftUI
...
* [NavigationTransitions](https://github.com/davdroman/swiftui-navigation-transitions) ⭐ 1,078 | 🐛 3 | 🌐 Swift | 📅 2026-07-27 - Pure SwiftUI Navigation animated transitions
...
* [SwiftUI-bez](https://github.com/kieranb662/SwiftUI-bez) ⭐ 108 | 🐛 2 | 🌐 Swift | 📅 2020-12-17 - Utilities for working with bezier curves in SwiftUI

## Blur

[scroll to top](#readme)

* [Colorful](https://github.com/Co2333/Colorful) ⭐ 390 | 🐛 0 | 🌐 Swift | 📅 2024-07-03 - A SwiftUI implementation of AppleCard's animated colorful blur background
* [SwiftUIVisualEffects](https://github.com/lucasbrown/swiftui-visual-effects) ⭐ 342 | 🐛 2 | 🌐 Swift | 📅 2020-09-09 - View modifiers that wrap UIVisualEffectView, with environment integration.
...
* [SlideOverCard](https://github.com/joogps/SlideOverCard) ⭐ 1,222 | 🐛 11 | 🌐 Swift | 📅 2024-03-29 - A SwiftUI card view, made great for setup interactions.
...
* [swiftui-charts](https://github.com/spacenation/swiftui-charts) ⭐ 805 | 🐛 10 | 🌐 Swift | 📅 2021-11-27 - SwiftUI Charts with custom styles
...
* [ACarousel](https://github.com/JWAutumn/ACarousel) ⭐ 533 | 🐛 32 | 🌐 Swift | 📅 2024-08-13 - A carousel view for SwiftUI

## Clock

[scroll to top](#readme)

* [SwiftClockUI](https://github.com/renaudjenny/SwiftClockUI) ⭐ 306 | 🐛 2 | 🌐 Swift | 📅 2023-03-05 - SwiftUI library to display a clock. You can move the arms to change the time, change the style of the clock and customise some configurations.
...
* [ASCollectionView](https://github.com/apptekstudios/ASCollectionView) ⚠️ Archived - A SwiftUI collection view with support for custom layouts, preloading, and more.
...
* [PredicateKit](https://github.com/ftchirou/PredicateKit) ⭐ 411 | 🐛 3 | 🌐 Swift | 📅 2024-04-05 - PredicateKit allows Swift developers to write expressive and type-safe predicates for CoreData using key-paths, comparisons and logical operators, literal values, and functions.
* [SwiftDB](https://github.com/vmanot/SwiftDB) ⭐ 342 | 🐛 0 | 🌐 Swift | 📅 2025-08-06 - A modern database abstraction layer, batteries included.
...
* [SwiftUIX](https://github.com/SwiftUIX/SwiftUIX) ⭐ 8,130 | 🐛 28 | 🌐 Swift | 📅 2026-08-09 - An extension to the standard SwiftUI library.
...
* [IrregularGradient](https://github.com/joogps/IrregularGradient) ⭐ 235 | 🐛 0 | 🌐 Swift | 📅 2024-02-22 - Create animated irregular gradients in SwiftUI
...
* [BSZoomGridScrollView](https://github.com/boraseoksoon/BSZoomGridScrollView) ⭐ 161 | 🐛 0 | 🌐 Swift | 📅 2021-04-06 - Fun GridScrollView written in SwiftUI + Combine, bridging between UIKit
* [FlowStack](https://github.com/johnsusek/FlowStack) ⚠️ Archived - A grid layout view for SwiftUI
* [MijickGridView](https://github.com/Mijick/GridView) ⭐ 126 | 🐛 1 | 🌐 Swift | 📅 2025-05-14 - Easy Grids with SwiftUI
* [Micro](https://github.com/onmyway133/Micro) ⭐ 77 | 🐛 0 | 🌐 Swift | 📅 2020-06-11 - Fast diffing and type safe SwiftUI style data source for UICollectionView
* [SDFlowLayout](https://github.com/sanhee16/SDFlowLayout) ⭐ 5 | 🐛 0 | 🌐 Swift | 📅 2024-11-07 - Flow Layout for iOS 14+ with SwiftUI
...
* [CachedAsyncImage](https://github.com/lorenzofiamingo/SwiftUI-CachedAsyncImage) ⭐ 708 | 🐛 17 | 🌐 Swift | 📅 2026-07-01 - 🗃️ The simplest way to add cache to your AsyncImage.
* [swiftui-image-viewer](https://github.com/Jake-Short/swiftui-image-viewer) ⭐ 497 | 🐛 12 | 🌐 Swift | 📅 2023-04-12 - Image viewer built in SwiftUI for both local and remote images
* [Longinus](https://github.com/KittenYang/Longinus) ⭐ 328 | 🐛 4 | 🌐 Swift | 📅 2022-12-03 - A pure Swift high-performance asynchronous image loading framework.
...
* [AnimatedImage](https://github.com/krzyzanowskim/SwiftUI.AnimatedImage) ⭐ 58 | 🐛 0 | 🌐 Swift | 📅 2021-07-31 - SwiftUI AnimatedImage View
* [NukeUI](https://github.com/kean/NukeUI) ⚠️ Archived - Lazy image loading for SwiftUI
* [CropImage](https://github.com/laosb/CropImage) ⭐ 14 | 🐛 0 | 🌐 Swift | 📅 2024-12-24 - A pure SwiftUI view where user can move and resize an image to a pre-defined size.

## List

[scroll to top](#readme)

* [AdvancedList](https://github.com/crelies/AdvancedList) ⭐ 303 | 🐛 2 | 🌐 Swift | 📅 2022-06-06 - Advanced List View for SwiftUI with pagination & different states
* [SwipeCell](https://github.com/EnesKaraosman/SwipeCell) ⭐ 274 | 🐛 0 | 🌐 Swift | 📅 2024-11-12 - Swipe Left2Right & Right2Left, pure SwiftUI implementation
* [EmptyList](https://github.com/Toni77777/EmptyList) ⭐ 7 | 🐛 0 | 🌐 Swift | 📅 2020-07-13 - EmptyList - List(SwiftUI) supports displaying Empty ListView for empty state
...
* [MarkdownUI](https://github.com/gonzalezreal/MarkdownUI) ⭐ 3,911 | 🐛 61 | 🌐 Swift | 📅 2025-12-28 - Render Markdown text in SwiftUI
...
* [ImmersiveMap](https://github.com/artembobkin/ImmersiveMap) ⭐ 88 | 🐛 2 | 🌐 Swift | 📅 2026-08-14 - A native Swift + Metal vector-tile map engine for SwiftUI with a 3D globe, starfield and labels
...
* [SideMenu](https://github.com/akardas16/SideMenu) ⭐ 51 | 🐛 2 | 🌐 Swift | 📅 2023-12-02 - This repository shows Side Menu written with SwiftUI

## Navigation

[scroll to top](#readme)

* [NavigationStack](https://github.com/matteopuc/swiftui-navigation-stack) ⭐ 996 | 🐛 22 | 🌐 Swift | 📅 2022-12-05 - An alternative SwiftUI NavigationView implementing classic stack-based navigation giving also some more control on animations and programmatic navigation.
...
* [Coordinator](https://github.com/SwiftUIX/Coordinator) ⭐ 297 | 🐛 8 | 🌐 Swift | 📅 2024-08-22 - A declarative navigation API for SwiftUI.
...
* [PermissionsSwiftUI](https://github.com/jevonmao/PermissionsSwiftUI) ⭐ 1,571 | 🐛 15 | 🌐 Swift | 📅 2024-04-06 - A SwiftUI package to beautifully display and handle permissions.
...
* [PreviewView](https://github.com/theoriginalbit/PreviewView) ⭐ 146 | 🐛 0 | 🌐 Swift | 📅 2024-05-19 - Make use of SwiftUI Previews for UIKit
* [Gala](https://github.com/finestructure/Gala) ⭐ 87 | 🐛 0 | 🌐 Swift | 📅 2020-08-21 - Create SwiftUI preview variants for macOS, iOS, tvOS, and watchOS with ease
* [FigmaPreviewSwiftUI](https://github.com/eDeniska/figma-preview-swiftui) ⭐ 60 | 🐛 0 | 🌐 Swift | 📅 2021-05-21 - Figma component preview for your SwiftUI views
* [ZeplinPreviewSwiftUI](https://github.com/eDeniska/figma-preview-swiftui) ⭐ 60 | 🐛 0 | 🌐 Swift | 📅 2021-05-21 - Zeplin component preview for your SwiftUI views
* [PreviewDevice](https://github.com/Toni77777/PreviewDevice) ⭐ 51 | 🐛 0 | 🌐 Swift | 📅 2024-11-02 - PreviewDevice - library with elegant syntax for Preview Device in SwiftUI
* [SafePreviewDevice](https://github.com/posix88/SafePreviewDevice) ⭐ 12 | 🐛 0 | 🌐 Swift | 📅 2022-01-17 - Safe and fast access to SwiftUI PreviewDevice.

## QRCode

[scroll to top](#readme)

* [CarBode](https://github.com/heart/CarBode-Barcode-Scanner-For-SwiftUI) ⭐ 303 | 🐛 17 | 🌐 Swift | 📅 2025-05-06 - CarBode : Free & Opensource barcode scanner & generator for SwiftUI
...
* [StarRating](https://github.com/dkk/StarRating) ⭐ 29 | 🐛 0 | 🌐 Swift | 📅 2022-11-29 - A customizable star rating control

## Search

[scroll to top](#readme)

* [SwiftlySearch](https://github.com/thislooksfun/SwiftlySearch) ⚠️ Archived - A small, lightweight UISearchController wrapper for SwiftUI
* [ShopSavvy](https://github.com/shopsavvy/swiftui-shopsavvy) ⭐ 0 | 🐛 0 | 🌐 Swift | 📅 2026-04-03 - SwiftUI views and @Observable view models for product search, price comparison, and deal discovery

## Settings

[scroll to top](#readme)

* [RRSettingsKit](https://github.com/rryam/RRSettingsKit) ⭐ 150 | 🐛 0 | 🌐 Swift | 📅 2026-07-11 - A beautiful customizable settings screen created in SwiftUI
...
* [FancyScrollView](https://github.com/nerdsupremacist/FancyScrollView) ⭐ 1,022 | 🐛 7 | 🌐 Swift | 📅 2021-10-29 - A SwiftUI ScrollView Designed to imitate the App Store and Apple Music ScrollViews (with or without a Parallax Header)
...
* [SwiftUI Drawer](https://github.com/maustinstar/swiftui-drawer) ⭐ 1,043 | 🐛 9 | 🌐 Swift | 📅 2022-03-21 - A SwiftUI bottom-up
...
* [SkeletonUI](https://github.com/CSolanaM/SkeletonUI) ⭐ 969 | 🐛 9 | 🌐 Swift | 📅 2024-08-10 - Elegant skeleton loading animation in SwiftUI and Combine.
...
* [Sliders SwiftUI](https://github.com/kieranb662/Sliders-SwiftUI) ⭐ 722 | 🐛 1 | 🌐 Swift | 📅 2026-03-13 - Collection of unique fully customizable SwiftUI sliders, joysticks, trackpads and more
...
* [SwiftSpeech](https://github.com/Cay-Zhang/SwiftSpeech) ⭐ 531 | 🐛 7 | 🌐 Swift | 📅 2021-07-27 - A speech recognition framework designed for SwiftUI.

## Stack

[scroll to top](#readme)

* [WrappingHStack](https://github.com/dkk/WrappingHStack) ⭐ 563 | 🐛 6 | 🌐 Swift | 📅 2023-10-26 - Like HStack, but automatically positions overflowing elements on next lines.

## Step

[scroll to top](#readme)

* [StepperView](https://github.com/badrinathvm/StepperView) ⭐ 1,362 | 🐛 11 | 🌐 Swift | 📅 2026-02-25 - SwiftUI iOS component for Step Indications.
...
* [AnimatedTabBar](https://github.com/exyte/AnimatedTabBar) ⭐ 545 | 🐛 0 | 🌐 Swift | 📅 2026-07-08 - A tabbar with number of preset animations written in pure SwiftU
...
* [iPhoneNumberField](https://github.com/MojtabaHs/iPhoneNumberField) ⭐ 583 | 🐛 6 | 🌐 Swift | 📅 2025-02-28 - Elegant SwiftUI phone number textField
* [FloatingLabelTextFieldSwiftUI](https://github.com/kishanraja/FloatingLabelTextFieldSwiftUI) ⭐ 492 | 🐛 16 | 🌐 Swift | 📅 2024-03-11 - Floating Label TextField for SwiftUI. FloatingLabelTextFieldSwiftUI
* [CurrencyText](https://github.com/marinofelipe/CurrencyText) ⭐ 235 | 🐛 7 | 🌐 Swift | 📅 2026-02-12 - Currency text field formatter
...
* [KeyboardAvoider](https://github.com/michaelhenry/KeyboardAvoider) ⚠️ Archived - The missing interactive keyboard in SwiftUI for iOS
* [OmenTextField](https://github.com/kitlangton/OmenTextField) ⭐ 135 | 🐛 1 | 🌐 Swift | 📅 2021-05-30 - A better TextField for SwiftUI. A growing, multiline, auto-focusable TextField supporting bindable focus
...
* [MijickPopups](https://github.com/Mijick/Popups) ⭐ 1,816 | 🐛 31 | 🌐 Swift | 📅 2025-10-22 - Popups, popovers, sheets, alerts, toasts, banners, (...) presentation made simple. Written with and for SwiftUI
...
* [SwiftUI-Tooltip](https://github.com/quassum/SwiftUI-Tooltip) ⭐ 376 | 🐛 7 | 🌐 Swift | 📅 2023-05-10 - Easy Tooltip for your SwiftUI Project

## Unit-testing

[scroll to top](#readme)

* [ViewInspector](https://github.com/nalexn/ViewInspector) ⭐ 2,629 | 🐛 58 | 🌐 Swift | 📅 2026-08-14 - Runtime introspection and unit testing of SwiftUI views

## Video

[scroll to top](#readme)

* [YouTubePlayerKit](https://github.com/SvenTiigi/YouTubePlayerKit) ⭐ 992 | 🐛 1 | 🌐 Swift | 📅 2025-12-25 - A Swift Package to easily play YouTube videos
